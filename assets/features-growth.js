...
(function(){
  ...
  function boot(){
    ...
    */
     ...
     */
    /**
     * Print sizes — `perPage` is the hard limit on one A4 sheet (page-break enforced).
     * `cols` is the grid width only. Large used to be 2-col with no page-break → 4/page.
     */
    const QR_PRINT_SIZES = {
      ...
      large: {
        ...
        gap: '8mm',
        margin: '12mm',
        // ~half of printable A4 height so two cards fill the sheet
        cardMinH: '118mm',
        showSteps: true,
        showMeta: true,
      },
