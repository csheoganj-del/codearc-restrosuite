            ...
            <div style="display:flex;flex-direction:column;gap:8px">
              ${users.slice(0, 12).map((u, i) => {
                ...
                return `<div style="display:flex;align-items:center;gap:10px;padding:10px 12px;border:1px solid var(--stroke);border-radius:10px;background:var(--glass)">
                  <div class="emp-av" style="width:34px;height:34px;border-radius:50%;display:grid;place-items:center;font-size:12px;font-weight:700;background:${avatarColors[i % avatarColors.length]}">${_e(initials(name))}</div>
