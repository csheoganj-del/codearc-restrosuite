...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupWebView() {
        ...
        // Hardened: the app loads from a remote HTTPS origin and persists
        // data via DOM storage / WebSQL, not file://. Disabling file access
        // and cross-origin file reads closes a local file-exfiltration vector.
