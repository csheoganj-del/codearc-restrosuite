...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.rs-sa-card{background:#1c2536;color:#fff;border:1px solid rgba(252,128,25,.55);border-left:5px solid #FC8019;border-radius:12px;padding:12px 14px;box-shadow:0 12px 32px rgba(0,0,0,.35);display:flex;align-items:center;gap:12px;animation:rsSaIn .3s ease;}',
      ...
      '.rs-sa-ic{width:38px;height:38px;border-radius:10px;background:rgba(252,128,25,.18);color:#FC8019;display:flex;align-items:center;justify-content:center;font-size:16px;flex-shrink:0;animation:rsSaPulse 1.6s ease-in-out infinite;}',
      ...
      '.rs-sa-ack{background:#FC8019;color:#fff;border:none;border-radius:9px;padding:9px 13px;font-weight:800;font-size:12px;cursor:pointer;flex-shrink:0;}',
