...
(function (root, factory) {
  ...
  function renderTableAddBtn() {
    return '<button aria-label="Add new table to floor layout"><i class="fa-solid fa-plus" aria-hidden="true"></i></button>';
  }

  function renderTableReserveBtn(tableId) {
    return `<button aria-label="Create reservation for table ${tableId}"><i class="fa-solid fa-calendar-plus" aria-hidden="true"></i></button>`;
  }

  function renderTableSeatWaitlistBtn() {
    return '<button aria-label="Seat next guest from waitlist to available table"><i class="fa-solid fa-chair" aria-hidden="true"></i></button>';
  }

  function renderTableClearBtn(tableId) {
    return `<button aria-label="Mark table ${tableId} as available and reset status"><i class="fa-solid fa-broom" aria-hidden="true"></i></button>`;
  }

  return { create, renderFloorPlan, renderTableTile, STATUS_COLOR, TABLE_STATUS, RESERVATION_STATUS, WAITLIST_STATUS, renderTableAddBtn, renderTableReserveBtn, renderTableSeatWaitlistBtn, renderTableClearBtn };
});
