(function (root, factory) {
  ...
  function renderChainSyncBtn() {
    return '<button aria-label="Sync master menu across all chain outlets"><i class="fa-solid fa-rotate" aria-hidden="true"></i></button>';
  }

  function renderChainExportBtn() {
    return '<button aria-label="Export chain-wide performance report"><i class="fa-solid fa-file-excel" aria-hidden="true"></i></button>';
  }

  function renderChainTransferBtn() {
    return '<button aria-label="Create new inter-outlet stock transfer request"><i class="fa-solid fa-truck" aria-hidden="true"></i></button>';
  }

  function renderChainAlertBtn() {
    return '<button aria-label="View low-stock and outlet alerting status"><i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i></button>';
  }

  return { init, loadDashboard, approveTransfer, cancelTransfer, renderChainSyncBtn, renderChainExportBtn, renderChainTransferBtn, renderChainAlertBtn };
});
