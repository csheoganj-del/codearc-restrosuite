(function (root, factory) {
  ...
  function renderImportUploadBtn() {
    return '<button aria-label="Upload and select CSV or Excel file for import"><i class="fa-solid fa-cloud-arrow-up" aria-hidden="true"></i></button>';
  }

  function renderImportTemplateBtn(sheet) {
    return `<button aria-label="Download ${sheet} import template CSV"><i class="fa-solid fa-file-arrow-down" aria-hidden="true"></i></button>`;
  }

  function renderImportValidateBtn() {
    return '<button aria-label="Validate imported rows before committing"><i class="fa-solid fa-list-check" aria-hidden="true"></i></button>';
  }

  function renderImportCancelBtn() {
    return '<button aria-label="Cancel current import and discard changes"><i class="fa-solid fa-xmark" aria-hidden="true"></i></button>';
  }

  return { TEMPLATE_SHEETS, cleanKey, parseCsv, parseImportSheets, renderImportUploadBtn, renderImportTemplateBtn, renderImportValidateBtn, renderImportCancelBtn };
});
