 ...
 *   E2E_BASE_URL=https://codearc-restrosuite.vercel.app node scripts/check-prod-assets.cjs
 */
const https = require('https');
const http = require('http');

const base = (process.env.E2E_BASE_URL || process.env.BASE_URL || 'https://codearc-restrosuite.vercel.app').replace(
  /\/$/,
  ''
);
