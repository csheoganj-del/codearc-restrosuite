(function (root, factory) {
  ...
  function renderBillsExportBtn() {
    return '<button aria-label="Export bills as CSV file"><i class="fa-solid fa-file-export" aria-hidden="true"></i></button>';
  }

  function renderBillsFilterBtn() {
    return '<button aria-label="Open bills filter panel by date and status"><i class="fa-solid fa-filter" aria-hidden="true"></i></button>';
  }

  function renderBillsReprintBtn(billId) {
    return `<button aria-label="Reprint bill ${billId} receipt copy"><i class="fa-solid fa-print" aria-hidden="true"></i></button>`;
  }

  function renderBillsRefundBtn(billId) {
    return `<button aria-label="Initiate refund for bill ${billId}"><i class="fa-solid fa-arrow-rotate-left" aria-hidden="true"></i></button>`;
  }

  return { convertToCSV, parseBillDate, renderBillsExportBtn, renderBillsFilterBtn, renderBillsReprintBtn, renderBillsRefundBtn };
});
